const styles = {
    ...
    heading:"text-[25px] text-center md: text-start font-[600] font-Roboto pb-[20px]",
    ...
    active_indicator: "absolute bottom-[-27px] left-0 h-[3px] w-full bd-[crimson]",
    button: "w-[150px] bg-black h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
    cart_button: "px-[20px] h-[30px] rounded-[20px] bg-[#f63b60] fle items-center justify-center cursor-pointer",
